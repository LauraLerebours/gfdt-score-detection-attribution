...
initial_conditions = rand_start.randint(low=0, high=len(base_x)-1, size=5000)  # Generate 400 random initial conditions
trajectory = []
differences = []
...
plt.plot(time_axis, trajectory, label='Average Squared Trajectory Difference', color='red')
