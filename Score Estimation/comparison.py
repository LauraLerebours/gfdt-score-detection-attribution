...
with torch.no_grad():
    stein_old, residuals_old = dsm_with_stein.stein_loss(dsm_only_model, data, mu, sigma_x, K=K)
    stein_new, residuals_new = dsm_with_stein.stein_loss(with_stein_model, data, mu, sigma_x, K=K)
